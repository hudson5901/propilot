    ...
    <div className="min-h-screen bg-surface-secondary">
      <header className="bg-white border-b border-border">
        <div className="mx-auto max-w-4xl px-6 py-8">
          <Link href="/app/results" className="text-sm text-accent hover:underline mb-4 inline-block">
            &larr; マッチング結果に戻る
          </Link>
        </div>
      </header>
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex gap-3">
                <Link href="/app/chat" className="inline-flex items-center rounded-lg bg-accent px-6 py-2.5 text-sm font-semibold text-white hover:bg-accent-hover transition-colors">
                  この専門家に相談する
                </Link>
