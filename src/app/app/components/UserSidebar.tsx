...
const NAV_ITEMS: { href: string; label: string; Icon: LucideIcon }[] = [
  { href: "/app/user-dashboard", label: "ダッシュボード", Icon: LayoutDashboard },
  { href: "/app/chat", label: "チャット", Icon: MessageSquare },
  { href: "/app/documents", label: "書類", Icon: FileText },
  { href: "/app/payments", label: "お支払い", Icon: CreditCard },
  { href: "/app/ai-consultation", label: "AI相談", Icon: Bot },
